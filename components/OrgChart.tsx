...
export const OrgChartComponent: React.FC<OrgChartComponentProps> = ({
  data,
}) => {
  ...
  useLayoutEffect(() => {
    ...
    chartRef.current
      ...
      .nodeContent((d: d3.HierarchyNode<OrgChartNode>) => {
        const node = d as OrgChartRenderedNode;

        return `
          <div style="padding-top:30px;margin-left:1px;height:${
            node.height
            ...
            <a href="https://${
              ...
              <div style="height:${
                node.height - 32
              }px;background-color:white;border:1px solid lightgray;border-radius:20px;">
    ...
    // Disable zoom/pan so chart stays static
